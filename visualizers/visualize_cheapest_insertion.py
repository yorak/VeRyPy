...
insert_re = re.compile("Chose to insert n([0-9]+) resulting in route (\[.*?\])")
route_complete_re =  re.compile("Route \#([0-9]+) finished as (\[.*?\])")
...
if __name__=="__main__":
    visualize_procedure("cheapest_insertion", selector=VISUALIZE.ALL, make_anim=MAKE_ANIM, 
